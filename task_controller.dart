...
Future<void> editTask(Task task, String name, int color, String salary, String description) async{
  List<Task> tasksList = await getTasks();
  try{
    ...
    tasksList.singleWhere((item) => item.id == task.id).description= description;
  }catch(e){
